...
def bycatch():
    ...
    for step in range(num_steps):
        fish_1[step + 1] = fish_1[step] + h * (fish_1[step] * maximum_growth_rate_1 * (1 - fish_1[step] / carrying_capacity_1) - (1 - p) * harvest_rate)# fill this in
        fish_2[step + 1] = fish_2[step] + h * (fish_2[step] * maximum_growth_rate_2 * (1 - fish_2[step] / carrying_capacity_2) - p * harvest_rate)# fill this in
